...
const { creerAdmin } = require('./controllers/creerAdminController'); // TEMPORAIRE - à retirer après usage
...
app.get('/api/creer-admin', creerAdmin); // TEMPORAIRE - à retirer après usage
