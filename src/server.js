...
const { lancerSeed } = require('./controllers/seedController'); // TEMPORAIRE - à retirer après usage
...
app.get('/api/seed-initial', lancerSeed); // TEMPORAIRE - à retirer après usage
