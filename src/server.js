...
const { ajusterTarifs } = require('./controllers/ajusterTarifsController'); // TEMPORAIRE - à retirer après usage
...
app.get('/api/ajuster-tarifs', ajusterTarifs); // TEMPORAIRE - à retirer après usage
